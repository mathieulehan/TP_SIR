...
/**
 * Service gerant les sondages de type date & lieu
 * @author mathi
 *
 */
...
public class SurveyDateLocationService extends AbstractService<SondageTypeDateEtLieu>{
	...
	public Response create(String json) throws JSONException, ParseException {
		...
		SondageTypeDateEtLieu surveyEntity = new SondageTypeDateEtLieu();
		...
		lieu.setEnonce(survey.getString("choix_location"));
		choix.add(date);
		choix.add(lieu);
